import { createSchema, type WeaverseImage, IMAGES_PLACEHOLDERS } from "@weaverse/hydrogen";
...
function ClubComparison(props: ClubComparisonProps) {
  ...
  return (
    <Section ref={ref} {...rest}>
      {heading && (
        <h2 className="mb-12 text-center font-henderson-slab text-[32px] uppercase">
          {heading}
        </h2>
      )}
...
export const schema = createSchema({
      ...
      inputs: [
        {
          ...
          name: "heading",
          label: "Heading",
          defaultValue: "Select a Club Membership That Matches Your Wine Preferences and Delivery Frequency.",
        },
      ],
    },
    ...sectionSettings,
  ...
  presets: {
    heading: "Select a Club Membership That Matches Your Wine Preferences and Delivery Frequency.",
    gap: 48,
    children: [
      {
      ...
      },
      {
        ...
        benefits: "<ul><li>Ships 6 times a year</li><li>Choose from 2, 3, 4 or 6 bottles per shipment</li><li>10% off first club shipment</li><li>Option to personalize your wine selections</li><li>Flat-rate club shipping $XX</li><li>Signature Select club discounted merchandise option</li><li>Spend will automatically go towards your WinePlus loyalty status</li><li>No contracts, no commitment; edit or cancel anytime</li></ul>",
        buttonText: "GET STARTED",
        buttonLink: "#",
      },
      {
        ...
        benefits: "<ul><li>Ships 4 times a year</li><li>Choose from 2, 3, 4, or 6 bottles per shipment</li><li>10% off first club shipment</li><li>Option to personalize your wine selections</li><li>Flat-rate club shipping $XX</li><li>Four Seasons club discounted merchandise option</li><li>Spend will automatically go towards your WinePlus loyalty status</li><li>No contracts, no commitment; edit or cancel anytime</li></ul>",
        buttonText: "GET STARTED",
        buttonLink: "#",
      },
      {
      ...
      },
      {
        ...
        benefits: "<ul><li>Ships 2 times a year (Spring & Fall)</li><li>12 bottles of Winemaker's handpicked wines</li><li>Option to personalize your wine selections</li><li>Welcome package and gift ($30 value)</li><li>Complimentary keepsake 6-bottle wooden crate</li><li>Spend will automatically go towards your WinePlus loyalty status</li></ul>",
        buttonText: "GET STARTED",
        buttonLink: "#",
      },
    ],
