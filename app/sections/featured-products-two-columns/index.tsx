...
export const loader = async ({
  ...
  // Slicing to 2 products max for auto fallback
  return { 
    products: {
      ...featuredProducts,
      nodes: featuredProducts?.nodes?.slice(0, 2) || []
    } 
  };
};

export const schema = createSchema({
  type: "featured-products-two-columns",
  title: "Featured Products Two Columns",
  childTypes: [
    "featured-products-two-columns--header",
    "featured-products-two-columns-items",
    "heading",
    "subheading",
    "paragraph",
  ],
  ...
  presets: {
    ...
    children: [
      {
        type: "featured-products-two-columns--header",
        children: [
          {
            type: "heading",
