  ...
  settings: [
      ...
      inputs: [
        {
          ...
          label: "Heading",
          defaultValue: "Are you 21 or older?",
        ...
        },
        {
          ...
          label: "Description",
          defaultValue:
            "You must be at least 21 years of age to view this site.",
          placeholder:
            "You must be at least 21 years of age to view this site.",
        },
        {
          type: "text",
          name: "ageVerificationYesButton",
          label: "Yes button text",
          defaultValue: "ENTER SITE",
          placeholder: "ENTER SITE",
        },
        {
          type: "text",
          name: "ageVerificationNoButton",
        ...
        {
          type: "range",
          name: "ageVerificationHeadingSize",
        ...
        {
          type: "range",
          name: "ageVerificationHeadingMobileSize",
        ...
        {
          type: "range",
          name: "ageVerificationDescriptionSize",
        ...
        {
          type: "range",
          name: "ageVerificationDescriptionMobileSize",
          label: "Description mobile font size",
          configs: {
            min: 12,
            max: 24,
            step: 1,
        ...
        {
          type: "color",
          name: "ageVerificationBgColor",
          label: "Background color",
          defaultValue: "#000000",
        },
        {
          type: "color",
          name: "ageVerificationHeadingColor",
          label: "Heading color",
          defaultValue: "#ffffff",
        },
        {
          type: "color",
          name: "ageVerificationDescriptionColor",
          label: "Description color",
          defaultValue: "#ffffff",
        },
        {
          type: "color",
          name: "ageVerificationYesButtonBg",
          label: "Yes button background",
          defaultValue: "#e91220",
        },
        {
          type: "color",
          name: "ageVerificationYesButtonBgHover",
          label: "Yes button background (hover)",
          defaultValue: "#c0101b",
        },
        {
          type: "color",
          name: "ageVerificationYesButtonTextColor",
          label: "Yes button text color",
          defaultValue: "#ffffff",
        },
        {
          type: "color",
          name: "ageVerificationNoButtonBg",
          label: "No button background",
          defaultValue: "#ffffff",
        },
        {
          type: "color",
          name: "ageVerificationNoButtonBgHover",
          label: "No button background (hover)",
          defaultValue: "#e5e7eb",
        },
        {
          type: "color",
          name: "ageVerificationNoButtonTextColor",
          label: "No button text color",
          defaultValue: "#000000",
        },
      ],
    },
    {
      ...
      inputs: [
        ...
        {
          type: "color",
          name: "newsletterPopupHeadingColor",
          label: "Heading color",
          defaultValue: "#ffffff",
          condition: (theme) => theme.newsletterPopupEnabled === true,
        },
        {
          type: "color",
          name: "newsletterPopupDescriptionColor",
          label: "Description color",
          defaultValue: "#ffffff",
          condition: (theme) => theme.newsletterPopupEnabled === true,
        },
        ...
        {
          type: "color",
          name: "newsletterPopupButtonBgHover",
        ...
        {
          type: "color",
          name: "newsletterPopupButtonTextColor",
          label: "Button text color",
          defaultValue: "#ffffff",
          condition: (theme) => theme.newsletterPopupEnabled === true,
        },
        {
          type: "color",
          name: "newsletterPopupDismissButtonBg",
          label: "Dismiss button background",
          defaultValue: "#e91220",
          condition: (theme) =>
            theme.newsletterPopupEnabled === true &&
            theme.newsletterPopupAllowDismiss === true,
        },
        {
          type: "color",
          name: "newsletterPopupDismissButtonBgHover",
          label: "Dismiss button background (hover)",
          defaultValue: "#c0101b",
          condition: (theme) =>
            theme.newsletterPopupEnabled === true &&
            theme.newsletterPopupAllowDismiss === true,
        ...
        {
          type: "color",
          name: "newsletterPopupDismissButtonTextColor",
        ...
        {
          type: "color",
          name: "newsletterPopupEmailBg",
          label: "Email input background",
          defaultValue: "#ffffff",
          condition: (theme) => theme.newsletterPopupEnabled === true,
        },
        {
          type: "color",
          name: "newsletterPopupEmailTextColor",
        ...
        {
          type: "color",
          name: "newsletterPopupEmailBorderColor",
        ...
        {
          type: "color",
          name: "newsletterPopupCloseIconColor",
